                        ...
                        <div className="my-10 lg:my-0 lg:w-6/12 lg:mx-auto">
                            <div className="bg-white border border-gray-200 rounded-lg shadow mx-10 lg:mx-5">
                                ...
                                <div className="p-5 shadow-xl">
                                    ...
                                    <a href="https://medium.com/@aliciautomo/mobile-jkn-a-ui-ux-redesign-case-study-43b29d60999f" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                                        Read more
                                        <svg className="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                        </svg>
