      ...
      <div className="bg-lime-50 py-40">
        <div className="mx-auto w-9/12 lg:flex">
          ...
          <div className="mt-10 lg:ml-20 lg:my-auto">
            ...
            of <span className="inline-block my-1 px-2 font-bold text-lg text-pink-900 bg-pink-200 rounded-md">UI/UX Design</span> and <span className="inline-block my-1 px-2 font-bold text-lg text-amber-900 bg-amber-200 rounded-md">Software Development</span>. Fusing technical
